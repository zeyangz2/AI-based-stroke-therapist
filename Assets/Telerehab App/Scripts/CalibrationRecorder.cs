...
public class CalibrationRecorder : MonoBehaviour
{
    ...
    IEnumerator RecordDataForFrame()
    {
        ...
        tw.WriteLine(
           "Time, Therapist position x,Therapist position y,Therapist position z,Patient position x,Patient position y,Patient position z"
            );
    ...
    public UnityEvent OnRecordStarted = new UnityEvent();
    public UnityEvent OnRecordEnded = new UnityEvent();
    private void Update()
    {
