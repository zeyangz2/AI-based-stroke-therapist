...
public class HapticEvents
{
    ...
    public UnityEvent<Collision> OnTouch;
}
#endregion
...
public class HapticPlugin : MonoBehaviour
{
    ...
    public Vector3 debug_force_collider;
    public float debug_force_collider_mag;
    public Vector3 debug_collision_obj;
    public float debug_collision_mag;

    public float debug_max_velocity;

    public Vector3 stiffnessForceD;
    public Vector3 viscosityForceD;
    public Vector3 dynamicFrictionForceD;
    public Vector3 staticFrictionForceD;
    public Vector3 constantForceD;
    public Vector3 springForceD;
    ...
    bool enable_GloablSpring = false;
    #endregion
    ...
    private void FixedUpdate()
    {
        if (DeviceHHD >= 0)
        {
            ...
            if (enable_Vibration)
            {
                setVibrationValues(DeviceIdentifier, Vector3ToDoubleArray(VibrationGDir), VibrationGMag, VibrationGFrequency, -1.0);
            }
    ...
    public void UpdateCollision(Collision collision, bool isCollisionStart, bool isCollision, bool isCollisionExit)
    {
        ...
        {
            isTouching = true;
            Events.OnTouch.Invoke(collision);
